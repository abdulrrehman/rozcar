...
import { Button, Row, Col, CardBody, FormGroup, Label, Input } from 'reactstrap';
...
class LandingPage extends Component {
    ...
    //     var slideIndex = 1;
    //     var i;
    //     var x = document.getElementsByClassName("mySlides w3-animate-opacity");
    ...
    render() {
        ...
        <div>
            ...
            {/* <div className ="w3-display-container w3-center">
                <button className="w3-button w3-block w3-green w3-hide-large w3-hide-medium"
             ...
             <div clasName="mySlides w3-animate-opacity">
                ...
                {/* <div className="w3-display-left w3-padding w3-hide-small">
                    <div className="w3-black w3-opacity w3-hover-opacity-off w3-padding-large w3-round-large">
                        ...
                        <p><button className="w3-button w3-block w3-red w3-round"
                        onclick="document.getElementById('download').style.display='block'">Download
                        <i className="fa fa-android"></i>
                        <i className="fa fa-apple"></i>
                        <i className="fa fa-windows"></i>
             ...
             {/* <div className="mySlides w3-animate-opacity">
                <img className="w3-image" src={slider3} alt="Image 3"> </img> */}
                ...
                {/* <div className="w3-display-left w3-padding w3-hide-small">
                    <div className="w3-black w3-opacity w3-hover-opacity-off w3-padding-large w3-round-large">
                        ...
                        <p><button className="w3-button w3-block w3-indigo w3-round"
                        onclick="document.getElementById('download').style.display='block'">Download
                        <i className="fa fa-android"></i>
                        <i className="fa fa-apple"></i>
                        <i className="fa fa-windows"></i>
            ...
            {/* </div>   */}
            {/* <a className="w3-button w3-black w3-display-right w3-margin-right w3-round w3-hide-small w3-hover-light-grey" onclick={(e) => this.plusDivs(1)}>Take Tour <i class="fa fa-angle-right"></i></a> */}
            ...
            <div className="w3-padding-64 w3-white">
                <div className="w3-row-padding">
                    ...
                    <img src = {DemoMap} class="w3-image w3-right w3-hide-small" width="200" height="471"></img>
                    ...
                    <img  className="w3-image w3-margin-top" width="335" height="471"></img>
                    </div>
                    </div>
                </div>
            </div> 
